...
void loop()
{
  ...
  //Serial.println(accel_t_gyro.value.x_accel/16384.0, DEC);
  //Serial.print(F(", "));
  Serial.println(-accel_t_gyro.value.y_accel/16384.0, DEC);
  //Serial.print(F(", "));
  //Serial.println(accel_t_gyro.value.z_accel/16384.0, DEC);
  //Serial.println(F(""));
 /*
